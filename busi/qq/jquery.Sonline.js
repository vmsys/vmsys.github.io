...
(function($){
	...
	$.fn.setList = function(opts){
		$("body").append("<div class='SonlineBox' id='SonlineBox' style='top:-600px;'><div class='openTrigger' style='display:none' title='展开'></div><div class='contentBox'><div class='closeTrigger'><img src='qq/closeBtnImg.gif' title='关闭' /></div><div class='titleBox'><span>皇族达人</span></div><div class='listBox'></div></div></div>");
