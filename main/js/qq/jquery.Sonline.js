...
(function($){
	...
	$.fn.setList = function(opts){
		$("body").append("<div class='SonlineBox' id='SonlineBox' style='top:-600px;'><div class='openTrigger' style='display:none' title='展开'></div><div class='contentBox'><div class='closeTrigger'><img src='http://vmsys.github.io/main/js/qq/closeBtnImg.gif' title='关闭' /></div><div class='titleBox'><span>逍遥客 管理组</span></div><div class='listBox'></div></div></div>");
